  ...
  return (
    <div className="max-w-[1540px] w-full m-auto">
      <div className="px-[25px] pt-[25px]">
        ...
        <p className="mb-[50px]">
          Dashboard • Blog • <span className="text-[#6C737F]">Create</span>
        </p>
        <div className="w-[1180px] h-[72px] border-1 border-[#00000014] px-[25px] flex items-center justify-between mb-[95px]">
          ...
          <div className="flex gap-[12px] items-center">
            ...
            <Link tp={"/"}>
              <button className="w-[151px] h-[40px] rounded-[12px] bg-[#6366F1] text-white">
                Publish changes
              </button>
            </Link>
            <HiDotsHorizontal />
        ...
        <div className="flex gap-[300px] mb-[80px]">
          <h4 className="font-bold text-base text-[#111927] w-[200px]">
            Basic details
          </h4>
          <div>
            <input
              className="w-[700px] h-[55px] rounded-[8px] mb-[23px] border-1 border-[#E5E7EB] indent-5"
              type="text"
              placeholder="Post title"
            />
            <input
              className="w-[700px] h-[55px] rounded-[8px] border-1 border-[#E5E7EB] indent-5"
              type="text"
        ...
        <div className="flex justify-between mb-[80px]">
          ...
          <div>
            ...
            <div className="flex gap-[15px] items-center justify-center">
              <div className="w-[63px] h-[63px] rounded-[50%] bg-[#E5E7EB] flex items-center justify-center">
                <CiExport className="text-2xl text-black" />
              </div>
              <div>
        ...
        <div className="flex justify-between mb-[80px]">
          ...
          <div>
            <div className="w-[700px] h-[41px] flex items-center gap-[20px] bg-[#F2F4F7] pl-[15px] mb-[2px]">
              Normal <RiExpandUpDownFill /> B I U <FiPaperclip />{" "}
              <AiOutlineBars /> <FaBars />{" "}
              <span>
                T<sub>x</sub>
              </span>
            </div>
