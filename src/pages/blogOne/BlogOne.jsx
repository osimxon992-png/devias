  ...
  return (
    <div className="max-w-[1540px] w-full m-auto">
      <div className="px-[25px] pt-[25px]">
        ...
        <p className="mb-[50px]">
          Dashboard • Blog • <span className="text-[#6C737F]">List</span>
        </p>
        ...
        <p className="font-normal text-base text-[#6C737F] w-[695px] mb-[20px]">
        ...
        <div className="flex justify-between flex-wrap gap-[7px] mb-[45px]">
          <div className="border-1 border-[#00000014] rounded-tr-[15px] rounded-tl-[15px]">
            <img
              ...
              src={teamImg}
              alt=""
              className="mb-[30px] rounded-tr-[15px] rounded-tl-[15px]"
            />
            <div className="px-[10px] mb-[10px]">
              <div className="w-[107px] h-[32px] bg-[#1119271F] rounded-[16px] flex items-center justify-center mb-[15px]">
                Programming
              </div>
              <h3 className="font-bold text-[23px]">
                Why I Still Lisp, and You Should Too
              </h3>
              <p className="font-normal text-base text-[#6C737F] w-[500px] mb-[20px]">
          ...
          <div className="border-1 border-[#00000014] rounded-tr-[15px] rounded-tl-[15px]">
            ...
            <div className="px-[10px] mb-[10px]">
              <div className="flex items-center justify-between">
                <div className="w-[107px] h-[32px] bg-[#1119271F] rounded-[16px] flex items-center justify-center">
                  Productivity
                </div>
          ...
          <div className="border-1 border-[#00000014] rounded-tr-[15px] rounded-tl-[15px]">
            ...
            <div className="px-[10px] mb-[10px]">
              ...
              <h3 className="font-bold text-[23px] w-[500px]">
                How Model View Controller (MVC) Architectures Work
              </h3>
              <p className="font-normal text-base text-[#6C737F] w-[500px] mb-[20px]">
                Praesent eget leo mauris. Morbi ac vulputate nibh. In hac
          ...
          <div className="border-1 border-[#00000014] rounded-tr-[15px] rounded-tl-[15px]">
            ...
            <div className="px-[10px] mb-[10px]">
              ...
              <p className="font-normal text-base text-[#6C737F] w-[500px] mb-[20px]">
                Phasellus eu commodo lacus, eget tristique nunc. Ut ullamcorper
                semper nunc sit amet vehicula.
              </p>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-[10px]">
        ...
        <div className="flex items-center justify-center gap-[20px] mb-[77px]">
          <p className="text-[#11192761] flex items-center gap-[5px]">
            <FaArrowLeft /> Newer
          </p>
          <p className="text-[#6366F1] flex items-center gap-[5px]">
            Older posts <FaArrowRight />
          </p>
        </div>
