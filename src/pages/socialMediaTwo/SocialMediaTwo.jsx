  ...
  return (
    <div className="max-w-[1540px] w-full m-auto">
      <div className="px-[100px] pt-[25px]">
        ...
        <h1 className="font-bold text-[33px] text-[#111927] mb-[24px]">
        ...
        <div className="border-2 border-[#0000000A] py-[28px] px-[23px] mb-[25px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="w-[70px] h-[40px] bg-[#6366F1] text-white rounded-[12px]">
              Post
            </button>
          </div>
        </div>
        <div className="py-[20px] px-[23px] border-2 border-[#0000000A]">
          <div className="flex gap-[15px] items-center mb-[20px]">
            ...
            <div>
              ...
              <p className="flex items-center gap-[5px] text-[#6C737F]">
                <CiClock2 />
                35 minutes ago
              </p>
            </div>
          ...
          <div className="flex justify-between mb-[25px]">
            <p className="flex items-center gap-[5px] text-[#6C737F]">
              <FaRegHeart className="text-[#F04438]" /> 1
            </p>
            <BsShare />
          </div>
          ...
          <div className="flex  gap-[15px] mb-[44px]">
            <div>
              <img src={femaleFaceThree} alt="" />
            </div>
            <div className="w-full h-[83px] bg-[#F3F4F6] flex justify-between py-[5px] px-[5px]">
              <div>
                <p className="font-medium text-base text-[#111927] mb-[10px]">
                  Fran Perez
                </p>
        ...
        <div className="w-full py-[20px] px-[23px] border-2 border-[#0000000A] mb-[25px]">
          <div className="flex gap-[15px] items-center mb-[20px]">
            ...
            <div>
              ...
              <p className="text-[#6C737F] flex items-center gap-[5px]">
                <CiClock2 /> 4 hours ago
              </p>
            </div>
          </div>
          <p className="mb-[20px]">
          ...
          <div className="flex justify-between mb-[50px]">
            <p className="flex items-center gap-[5px]">
              <FaRegHeart className="text-[#F04438]" /> 24
            </p>
            <BsShare />
          </div>
          ...
          <div className="flex  gap-[15px] mb-[44px]">
            ...
            <div className="w-full h-[83px] bg-[#F3F4F6] flex justify-between py-[5px] px-[5px]">
              <div>
                ...
                <p className="text-sm">
                  Hmm, honestly this looks nice but I would change the shadow
                  though
                </p>
              </div>
        ...
        <div className="w-full py-[20px] px-[23px] border-2 border-[#0000000A]">
          <div className="flex gap-[15px] items-center mb-[20px]">
            ...
            <div>
              <p>Anika Visser updated her status</p>
              <p className="flex items-center gap-[5px] text-[#6C737F]">
                <CiClock2 /> 7 hours ago
              </p>
            </div>
          </div>
          <p className="mb-[30px]">
            As a human being, you are designed in a way that makes you incapable
            of experiencing any positive emotion unless you set an aim and
            progress towards it. What makes you happy is not, in fact, attaining
            it, but making progress towards it.
          </p>
          <div className="flex justify-between mb-[25px]">
            <p className="flex items-center gap-[5px] text-[#6C737F]">
              <FaRegHeart /> 65
          ...
          <div className="flex mb-[15px] gap-[15px]">
            ...
            <div className="w-full h-[83px] bg-[#F3F4F6] flex justify-between py-[15px] px-[15px]">
              <div>
                ...
                <p className="text-sm">
                  That’s actually deep. Thanks for the design, would you
                  consider making an interaction?
                </p>
              </div>
              <p className="text-[#6C737F] text-xs">3 hours ago</p>
            </div>
